...
namespace DASoTiemChung.Migrations
{
    ...
    [Migration("20221107191923_Initial")]
            ...
            modelBuilder.Entity("DASoTiemChung.Models.PhieuNhap", b =>
                {
                    ...
                    b.HasIndex(new[] { "MaKho" }, "IX_PhieuNhap_MaKho");

                    b.HasIndex(new[] { "MaNhaSanXuat" }, "IX_PhieuNhap_MaNhaSanXuat");
            ...
            modelBuilder.Entity("DASoTiemChung.Models.PhieuXuat", b =>
                {
                    ...
                    b.HasIndex(new[] { "MaKho" }, "IX_PhieuXuat_MaKho");

                    b.HasIndex(new[] { "MaNhanVien" }, "IX_PhieuXuat_MaNhanVien");

                    b.HasIndex(new[] { "MaVacXin" }, "IX_PhieuXuat_MaVacXin");
